    ...
    public class PermissionService : BaseService, IPermissionService
    {
        ...
        public IEnumerable<UserRelationEntity> GetMemberList(string objectId)
        {
            List<UserRelationEntity> res =
                o.BllSession.UserRelationBll.FindList(u => u.ObjectId.Equals(objectId))
        ...
        {
            List<UserRelationEntity> res =
                o.BllSession.UserRelationBll.FindList(u => u.UserId.Equals(userId))
                    .OrderByDescending(u => u.CreateDate)
                    .ToList();
        ...
        public IEnumerable<AuthorizeEntity> GetModuleList(string objectId)
        {
            List<AuthorizeEntity> res =
                o.BllSession.AuthorizeBll.FindList(u => u.ObjectId.Equals(objectId) && u.ItemType == 1)
                    .ToList();
        ...
        {
            List<AuthorizeEntity> res =
                o.BllSession.AuthorizeBll.FindList(u => u.ObjectId.Equals(objectId) && u.ItemType == 2)
                    .ToList();
        ...
        {
            List<AuthorizeEntity> res =
                o.BllSession.AuthorizeBll.FindList(u => u.ObjectId.Equals(objectId) && u.ItemType == 3)
                    .ToList();
        ...
        public IEnumerable<AuthorizeDataEntity> GetAuthorizeDataList(string objectId)
        {
            List<AuthorizeDataEntity> res =
                o.BllSession.AuthorizeDataBll.FindList(u => u.ObjectId.Equals(objectId))
        ...
        {
            //先清除历史授权数据
            int isSucc = o.BllSession.AuthorizeBll.Delete(u => u.ObjectId.Equals(objectId));
            if (isSucc > 0)
            {
                #region 功能
                ...
                //保存
                o.BllSession.AuthorizeBll.Insert(authorizeMenuList);
                #endregion
                ...
                //保存
                o.BllSession.AuthorizeBll.Insert(authorizeButtonList);
                #endregion
                ...
                //保存
                o.BllSession.AuthorizeBll.Insert(authorizeViewList);
                #endregion

                #region 数据权限
                //清除数据权限
                isSucc = o.BllSession.AuthorizeDataBll.Delete(u => u.ObjectId.Equals(objectId));
                int sortCode = 1;
                ...
                //保存
                o.BllSession.AuthorizeDataBll.Insert(authorizeDataTempList);
                #endregion
            }
        }
