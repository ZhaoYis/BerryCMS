...
namespace BerryCMS.BLL.SystemManage
{
    ...
    /// 数据字典明细
    /// </summary>
    public class DataItemDetailBLL : BaseBLL<DataItemDetailEntity>, IDataItemDetailBLL
    {
        private readonly DataItemDetailService _dataItemDetailService = new DataItemDetailService();
        ...
        {
            Idal = DbSession.DataItemDetailDal;
        }
